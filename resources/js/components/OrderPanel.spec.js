...
describe('OrderPanel cart-only UX', () => {
    ...
    it('renders compact desktop cart item layout with unified list styling', () => {
        ...
        expect(stepperClasses).toContain('w-[4.5rem]');
        expect(stepperClasses).toContain('grid-cols-[1.375rem_1.75rem_1.375rem]');
