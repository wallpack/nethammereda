                    ...
                    >
                        <CardContent class="space-y-2.5 p-0">
                            <div class="p-1.5 pb-0 max-[430px]:p-0">
                                <Skeleton class="mx-auto size-[176px] max-w-full rounded-[1rem] bg-[#f2f2f2] max-[430px]:size-auto max-[430px]:aspect-square max-[430px]:h-auto max-[430px]:w-full max-[430px]:rounded-2xl" />
                            </div>
